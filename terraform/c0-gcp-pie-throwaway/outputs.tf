...
output "ert_gateway_2" {
  value = "${google_compute_subnetwork.subnet-ert-2.gateway_address}"
}

output "ert_cidr_2" {
  value = "${google_compute_subnetwork.subnet-ert-2.ip_cidr_range}"
}

output "ert_subnet_2" {
  value = "${google_compute_subnetwork.subnet-ert-2.name}"
}
